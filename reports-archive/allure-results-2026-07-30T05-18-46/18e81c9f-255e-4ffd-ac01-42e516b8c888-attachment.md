...
```ts
  ...
  10  |     await page.getByLabel('Email', { exact: true }).fill('usman+admin@geeksofkolachi.com');
  11  |     await page.getByRole('textbox', { name: 'Password', exact: true }).fill('Admin@123');
  12  |     await page.getByRole('button', { name: 'Login', exact: true }).click();
  13  |     await page.waitForURL('**/admin/dashboard');
  14  |     await page.waitForLoadState('networkidle');
  15  | 
  16  |     // Navigate to orders page via sidebar
  17  |     await page.getByRole('link', { name: 'Monitor Orders' }).click();
  18  |     await page.waitForURL('**/admin/orders');
  19  |     await page.waitForLoadState('networkidle');
  20  | 
  21  |     // Explore page structure
  22  |     console.log('=== URL ===');
  23  |     console.log(page.url());
  24  | 
