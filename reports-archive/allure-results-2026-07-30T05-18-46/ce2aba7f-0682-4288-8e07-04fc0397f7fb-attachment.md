...
- Name: admin/Monitor-Orders/orders-table.spec.ts >> Order Management — orders table >> 2.5 — No sorting available on table columns @regression
- Location: tests/admin/Monitor-Orders/orders-table.spec.ts:88:3
