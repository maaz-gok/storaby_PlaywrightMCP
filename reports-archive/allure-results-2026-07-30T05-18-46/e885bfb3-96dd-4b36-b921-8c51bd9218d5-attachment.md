...
- Name: admin/Monitor-Orders/orders-table.spec.ts >> Order Management — orders table >> 2.2 — Table displays 10 rows per page @smoke
- Location: tests/admin/Monitor-Orders/orders-table.spec.ts:37:3
