...
- Name: admin/Monitor-Orders/orders-table.spec.ts >> Order Management — orders table >> 2.1 — Table headers are correct @smoke
- Location: tests/admin/Monitor-Orders/orders-table.spec.ts:20:3
