...
- Name: admin/Monitor-Orders/orders-table.spec.ts >> Order Management — orders table >> 2.6 — Story column displays values in italic @smoke
- Location: tests/admin/Monitor-Orders/orders-table.spec.ts:100:3
